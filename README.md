...
2.5ft diameter light display at its core. Within, a bench invited
participants to rest just above the playa. The light display, crafted
with concentric circles, marks the current time, providing nuanced
granularity such as the hour and minute. A user-controllable central
light introduces an element of interactivity. With a control panel,
the participant can manage cycle time and spectrum hues, enhancing the
